            ...
            <div class="stats-row">
                    ...
                    <table class="stats-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                               ...
                               <td >
                               <div class="avaliabe_seats_box">
                               {{ $branch->available_seats }}
                               </div>
                            </td>

                           
                                <td>
                                <div class="occupied_seats_box">
                                {{ $branch->occupied_seats }}</td>
                                </div>
                ...
                <div class="stats-card metrics-container">
                    ...
                    <div>
                        ...
                        <div class="metric-value"><strong>{{ $bookingsCount}}</strong></div>
                    </div>
                </div>
            </div>
        </div>
